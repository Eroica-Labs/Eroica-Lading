...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-b from-warm-white via-white to-warm-white">
      {/* Animated Waves - Democratic Symphony */}
      <AnimatedWaves />
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: `
              linear-gradient(to right, #003366 1px, transparent 1px),
              linear-gradient(to bottom, #003366 1px, transparent 1px)
            `,
        ...
        {/* Gradient orbs */}
        <div className="absolute top-20 -left-40 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-heroic-200/30 to-transparent blur-3xl" />
        <div className="absolute bottom-0 right-0 w-[600px] h-[600px] rounded-full bg-gradient-to-tl from-civic-100/40 to-transparent blur-3xl" />
        
        {/* Floating decorative shapes */}
        <FloatingShape 
          className="absolute top-32 right-[15%] w-20 h-20 rounded-2xl bg-heroic-100/50 rotate-12"
          delay={0}
        />
        <FloatingShape 
          className="absolute top-[60%] left-[8%] w-16 h-16 rounded-full bg-civic-100/60"
          delay={1.5}
        />
        <FloatingShape 
          className="absolute bottom-32 right-[25%] w-12 h-12 rounded-xl bg-heroic-200/40 -rotate-12"
          delay={3}
        />
      </div>
